...
SELECT
  ...
  'אל תגידי "אין משימות" לפני list_tasks / בדיקת DB. "שלי בלבד" מאפס את פילטר הסוכנות בהדר ל"כל הסוכנויות" — אם בהדר נשאר MarketingCaptain בלבד, משימות מ-promo/DMM-MC נעלמות.',
