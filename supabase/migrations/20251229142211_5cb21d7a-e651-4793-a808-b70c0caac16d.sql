-- Drop and recreate get_unknown_chat_contacts to match frontend expectations
-- (Repeat in case partial failure from prior migration)
...
-- Fix linter warnings on helper trigger functions
