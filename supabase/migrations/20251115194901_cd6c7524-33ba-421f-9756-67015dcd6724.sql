...
CREATE INDEX IF NOT EXISTS idx_chat_messages_client_direction_read 
ON chat_messages(client_id, direction, read_at) 
WHERE direction = 'inbound';

CREATE INDEX IF NOT EXISTS idx_chat_messages_lead_direction_read 
ON chat_messages(lead_id, direction, read_at) 
...
CREATE INDEX IF NOT EXISTS idx_leads_agency_company 
ON leads(agency_id, company_name);

-- Create optimized function to get chat contacts with unread counts
