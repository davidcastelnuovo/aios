-- Delete all existing dynamic-tables menu items from all tenants
DELETE FROM public.menu_items 
WHERE menu_key = 'dynamic-tables';

-- Update function to not create dynamic-tables menu item for new tenants
