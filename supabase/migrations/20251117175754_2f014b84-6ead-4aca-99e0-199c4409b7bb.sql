...
-- Create RPC function to get unknown/group contacts with proper tenant isolation
CREATE OR REPLACE FUNCTION get_unknown_chat_contacts()
RETURNS TABLE (
  id TEXT,
  name TEXT,
  sender_phone TEXT,
...
BEGIN
  ...
  RETURN QUERY
  -- Part 1: Registered WhatsApp groups
  SELECT 
    wg.id::TEXT,
    wg.group_name,
