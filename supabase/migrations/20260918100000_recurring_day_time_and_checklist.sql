-- Explicit weekday / month-day for recurring human tasks, plus checklist subtasks.
...
COMMENT ON COLUMN public.tasks.recurrence_weekday IS
  '0=Sunday .. 6=Saturday for weekly recurrence; null otherwise.';
COMMENT ON COLUMN public.tasks.recurrence_monthday IS
  'Day of month (1-31) for monthly recurrence; clamped to month length.';
