-- 1) Idempotent Carmen task WhatsApp (e.g. Felix / Leon gets one task_assigned).
-- 2) Stop re-firing reminders when priority/due edits reset markers after send.
-- 3) Remove legacy trg_notify_task_assigned (direct trigger-automation duplicate).
