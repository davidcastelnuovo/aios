-- Campaign pulse WhatsApp delivery: once per week — Sunday 07:00 Asia/Jerusalem.
...
BEGIN
  ...
  -- Delivery window: Sunday 07:00 ±10 minutes (cron jitter).
...
-- Sunday 07:00 Israel (04:00 UTC during IDT; claim window tolerates ±10 min).
DO $pulse_crons$
DECLARE
  worker_secret text;
  existing_job bigint;
