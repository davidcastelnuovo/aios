-- Remove lead-integrations and chat-integrations menu items from all tenants
-- since the main integrations module already contains all of them
DELETE FROM public.menu_items 
WHERE menu_key IN ('lead-integrations', 'chat-integrations');

-- Also update the initialize_tenant_menu_items function to not include these items
