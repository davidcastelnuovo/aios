-- Drop and recreate get_unknown_chat_contacts with whatsapp_avatar_url
DROP FUNCTION IF EXISTS public.get_unknown_chat_contacts();

CREATE FUNCTION public.get_unknown_chat_contacts()
