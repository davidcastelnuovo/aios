...
DROP FUNCTION IF EXISTS public.get_chat_contacts(uuid, uuid[]);
DROP FUNCTION IF EXISTS public.get_chat_contacts(uuid, uuid[], public.chat_provider);
...
BEGIN
  ...
  SELECT * FROM (
    SELECT
      ...
      p_provider AS active_chat_provider,
