...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // ---- Multi-period GSC keyword aggregates (prevMonth / 3M / yearly) ----
    // Mirrors public-table so the shared dashboard's PublicSeoView shows the
    // same ranking-change columns as the shared SEO report.
