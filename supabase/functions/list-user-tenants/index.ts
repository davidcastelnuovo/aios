...
serve(async (req: Request) => {
  ...
  try {
    ...
    if (isSuperAdmin) {
      // Super admins see ALL tenants they are members of, plus those with allow_super_admin_access
      ...
      tenants = (allTenants || [])
        .filter((t: any) => t.allow_super_admin_access === true || memberTenantIds.has(t.id))
