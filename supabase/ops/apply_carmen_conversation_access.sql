-- Staging apply: carmen conversation access tables + identity columns
-- Trigger: apply-staging-sql-migration.yml on develop

-- (same as supabase/migrations/20260910120000_carmen_conversation_access.sql)
