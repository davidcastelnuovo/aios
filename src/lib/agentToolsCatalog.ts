...
export const AGENT_TOOLS_CATALOG: AgentToolEntry[] = [
  ...
  { name: "analyze_facebook_campaign", label: "ניתוח קמפיין FB", group: "פייסבוק" },
  { name: "list_facebook_ads", label: "רשימת מודעות FB", group: "פייסבוק" },
  { name: "inspect_facebook_ad", label: "בדיקת מודעת מקור FB", group: "פייסבוק" },
  { name: "fb_duplicate_ad_variants", label: "שכפול מודעה עם וריאציות קופי", group: "פייסבוק" },
  { name: "toggle_facebook_campaign", label: "הפעלה/השהיית קמפיין/מודעה", group: "פייסבוק" },
