          ...
          {frameDraft ? (
            <ScrollArea className="flex-1">
              <div className="space-y-4 p-4">
                ...
                <div><Label>טקסט על המסך</Label><Textarea className="mt-1 min-h-16" dir="rtl" value={frameDraft.overlayText} onChange={(event) => setFrameDraft({ ...frameDraft, overlayText: event.target.value })} /></div>
