          ...
          <div className="min-h-[110px] flex-1" dir="ltr">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data.days} margin={{ top: 4, right: 4, bottom: 0, left: 4 }} barCategoryGap={2}>
                <CartesianGrid vertical={false} stroke="rgba(167,139,250,0.12)" />
                <XAxis
                  dataKey="date"
                  tick={{ fill: "#9aa3c0", fontSize: 10, fontFamily: "JetBrains Mono, monospace" }}
                ...
                />
                <Tooltip content={<UsageTooltip />} cursor={{ fill: "rgba(167,139,250,0.08)" }} />
                <Bar dataKey="tokens" name="טוקנים ליום" fill={SERIES_VIOLET} radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
          {!data.tracked && (
