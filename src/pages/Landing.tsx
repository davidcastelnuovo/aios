...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden py-24 md:py-40 bg-gradient-to-br from-background via-primary/5 to-background">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-5xl mx-auto text-center space-y-10">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-primary/15 border border-primary/20 text-primary text-sm font-semibold animate-fade-in backdrop-blur-sm">
              <Sparkles className="h-4 w-4" />
              הפלטפורמה המובילה לסוכנויות דיגיטל בישראל
            </div>
            
            <div className="space-y-6">
              <h1 className="text-5xl md:text-7xl font-bold leading-tight">
                <span className="block">יצירה, צמיחה והתרחבות</span>
                <span className="block gradient-primary bg-clip-text text-transparent mt-3">
