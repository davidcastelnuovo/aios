          ...
          <Table className="min-w-[750px]">
            <TableHeader className="sticky top-0 z-10 bg-background">
              <TableRow className="whitespace-nowrap">
                ...
                <TableHead className="text-right sticky right-[50px] bg-background border-l z-20 w-[110px]">שם</TableHead>
            ...
            {stageLeads.map((lead: any) => (
              <TableRow key={lead.id} className="whitespace-nowrap">
                ...
                <TableCell className="font-medium sticky right-[50px] bg-background border-l z-10 w-[110px]">
                  <div className="flex items-center gap-2">
