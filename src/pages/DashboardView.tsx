...
const PLATFORM_CONFIG: Record<string, { name: string; color: string; bgColor: string }> = {
  ...
  facebook_ecommerce: { name: 'Facebook Ecommerce', color: 'text-green-600', bgColor: 'bg-green-100' },
  google_ads: { name: 'Google Ads', color: 'text-blue-500', bgColor: 'bg-blue-100' },
