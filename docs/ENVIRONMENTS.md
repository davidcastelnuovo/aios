...
- Historical source user IDs whose Auth account is gone are represented by permanently banned, email-less Staging identities; passwords, sessions and invitation grants are never reconstructed.
